...
var text = ["Разработанный мною проект по обучению нейронных сетей занял первые места в ряде региональных научно-практических конференций.", "Простая утилита для трансляции камеры в режиме 'Картинка в картинке'. Дизайн выполнен на стыке плоского дизайна и неоморфизма.", "Запущено частное облачное хранилище. Этот проект показал, что даже маломощные системы могут приносить пользу при грамотном использовании."];
